    ...
    <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-6">
      ...
      {mode === 'supabase' ? (
        <p className="mt-6 text-sm text-zinc-400">
          Sign in with your member account. Confirming this box does not approve an ID review. Adult pages stay
          closed until a reviewer sets age verification on your profile.
        </p>
      ) : null}
      {mode !== 'unconfigured' ? (
